    ...
    return (
        <header className="flex flex-wrap justify-between items-center sm:px-16 px-4 py-2 max-w-[1500px] w-full h-full mx-auto">
            <div className="flex w-full flex-wrap justify-between items-center">
                <Link href="/" className="text-2xl font-bold text-theme-primary hover:opacity-50 cursor-pointer mx-auto sm:mx-0">
                    Shoper
                </Link>
                ...
                <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none">
                    <Link
                        href='/basket'
                        className="flex-1 relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-theme-primary hover:bg-theme-secondary text-white font-bold py-2 px-4 rounded transition-all duration-300"
                    >
                    ...
                    <Link
                        href='/order'
                        className="flex-1 relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 border border-gray-600 hover:bg-theme-secondary text-gray-800 hover:text-white font-bold py-2 px-4 rounded transition-all duration-300"
                    >
